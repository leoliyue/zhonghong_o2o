...
if __name__ == '__main__':
    ...
    jg_broker_compary_phone = '13700000135' #机构公司/经纪人登陆账号
    building_name = '新奇世界-半山半岛' #'新奇世界-半山半岛' '北京中弘大厦'# 新奇世界-长白水镇4号地 #'新奇世界-长白水镇5号地' #新奇世界-济南鹊山 #济南中弘广场 #北京御马坊楼盘
    isdele_customer = True  #是否变更已存在的手机号
    customer_phone = '13000001338'
    # 13000001130
