...
def Creat_implement():
    ...
    Building_name='新奇世界-半山半岛' #北京中弘大厦 #新奇世界-半山半岛 # 新奇世界-夏各庄由山由谷
...
if __name__ == '__main__':
    ...
    #
    #
    # employee_user_name = 'zcsachtkf'
    # Building_name = '济南中弘广场'#'' #'北京中弘大厦' #新奇世界-夏各庄由山由谷 #新奇世界-半山半岛 #新奇世界-济南鹊山 #新奇世界-半岛蓝湾 #新奇世界-长白水镇5号地
